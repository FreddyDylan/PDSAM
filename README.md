...
python /segment-anythin-main/scripts/Inference.py
```

# pre-trained models

The pre-trained models on the five datasets are saved in the "/pre-trained models" folder.
